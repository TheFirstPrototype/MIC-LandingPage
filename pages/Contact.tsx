      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <div>
              <h2 className="text-3xl font-bold text-[#00274C] mb-8">Get in Touch</h2>
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-6">
                  <div className="bg-[#FFCB05] p-4 rounded-2xl text-[#00274C]">
                    <Mail size={32} />
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest">Email</h4>
                    <p className="text-xl font-bold text-[#00274C]">ontvgrin@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-[#00274C]">616 402 4714</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-[#00274C]">Michigan, USA</p>
                  </div>
                </div>
              </div>

              <div className="mt-12 p-8 bg-gray-50 rounded-3xl border border-gray-100">
                <h4 className="text-lg font-bold text-[#00274C] mb-2">Direct Contact</h4>
                <p className="text-gray-600 font-medium">Point of Contact: Kevin Moran</p>
              </div>
            </div>

            <div className="bg-[#00274C] p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
              ...
              <form className="relative z-10 space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <div>
                  ...
                  <select className="w-full bg-white/10 border border-white/20 rounded-xl px-5 py-4 text-white focus:outline-none focus:border-[#FFCB05] transition-colors appearance-none">
                    <option className="bg-[#00274C]">General Inquiry</option>
                    <option className="bg-[#00274C]">Summit Registration</option>
                    <option className="bg-[#00274C]">Sponsorship</option>
                    <option className="bg-[#00274C]">Volunteer Opportunities</option>
                    <option className="bg-[#00274C]">Pitch Competition</option>
                  </select>
                </div>
                <div>
                ...
                <button className="w-full bg-[#FFCB05] text-[#00274C] py-4 rounded-xl font-bold text-lg hover:bg-opacity-90 transition-all shadow-xl flex items-center justify-center gap-2">
