      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 mb-16">
            <h2 className="text-3xl font-bold text-[#16443A]">Watch the Action</h2>
            <p>
          ...
          <div className="bg-gray-50 p-12 rounded-3xl border border-gray-200 mb-16 shadow-inner">
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="md:w-2/3">
                <h2 className="text-3xl font-bold text-[#16443A] mb-4">Apply to Pitch</h2>
                ...
                <div className="mb-8">
                  <h4 className="font-bold text-[#16443A] uppercase tracking-wider mb-3 flex items-center gap-2">
                  ...
                  <ul className="bg-white p-4 rounded-xl border border-gray-200">
                    <li className="text-[#16443A] font-semibold">Must have a minimum viable product (MVP)</li>
                  </ul>
                </div>
                <a 
                  href="#" 
                  className="inline-flex items-center gap-2 bg-[#16443A] text-[#FFCB05] px-8 py-4 rounded-xl font-bold text-lg hover:scale-105 transition-transform"
                >
              ...
              <div className="md:w-1/3">
                <div className="bg-[#FFCB05] p-8 rounded-2xl text-center">
                  <h3 className="text-4xl font-black text-[#16443A] mb-2">$ CASH $</h3>
                  <p className="text-[#16443A] font-bold uppercase tracking-widest">Prizes for Winners</p>
                </div>
              </div>
            </div>
          </div>
