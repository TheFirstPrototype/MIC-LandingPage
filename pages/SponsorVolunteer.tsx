...
const SponsorCard: React.FC<{ tier: string; price: string; features: string[]; available: string }> = ({ tier, price, features, available }) => (
  <div className="bg-white border-2 border-gray-100 rounded-3xl p-8 flex flex-col shadow-lg hover:border-[#FFCB05] transition-all relative overflow-hidden">
    <div className="absolute top-0 right-0 bg-[#FFCB05] text-[#16443A] px-4 py-1 text-xs font-bold uppercase rounded-bl-xl">
      {available} Available
    </div>
    <h3 className="text-2xl font-bold text-[#16443A] mb-2">{tier}</h3>
    <p className="text-3xl font-black text-[#16443A] mb-6">{price}</p>
    ...
    <button className="w-full bg-[#16443A] text-[#FFCB05] py-3 rounded-xl font-bold hover:bg-[#003d7c] transition-colors">
      Select {tier}
    </button>
  </div>
);
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-3 mb-10">
            <DollarSign className="text-[#16443A]" size={36} />
            <h2 className="text-4xl font-bold text-[#16443A]">Sponsorship Packages</h2>
          </div>
          ...
          <div id="volunteer" className="bg-white p-12 rounded-[3rem] shadow-2xl border-4 border-[#FFCB05]/20 overflow-hidden relative">
            <div className="absolute top-0 right-0 p-8 opacity-5">
              <HandHeart size={200} className="text-[#16443A]" />
            </div>
            <div className="relative z-10 max-w-3xl">
              <div className="flex items-center gap-3 mb-6">
                <CalendarCheck className="text-[#16443A]" size={36} />
                <h2 className="text-4xl font-bold text-[#16443A]">Join Our Volunteer Team</h2>
              </div>
              ...
              <div className="space-y-4">
                <button className="bg-[#16443A] text-[#FFCB05] px-10 py-4 rounded-full font-bold text-lg hover:bg-opacity-90 transition-all flex items-center gap-2">
