      ...
      <div className="bg-[#00274C] py-20 text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-xl font-medium">
            <span className="flex items-center gap-2"><Calendar className="text-[#FFCB05]" /> Thursday, July 9, 2026</span>
            <span className="flex items-center gap-2"><MapPin className="text-[#FFCB05]" /> Kellogg Center, East Lansing, MI</span>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="mt-20 text-center bg-[#00274C] p-12 rounded-3xl text-white">
            ...
            <p className="text-2xl font-bold text-[#FFCB05]">Mark your calendar and be part of Michigan’s innovation community.</p>
          </div>
        </div>
      </section>
    </div>
